 ...
 * @author Propietario
 */
public class PositiveValidator  extends DefaultColumnValidator {
    //
    //********************************CONSTANTES********************************
    //
    ...
    public PositiveValidator(WrapperTable<? extends WrapperTable> wrapper,String columnName) {
        this.setWrapper(wrapper);
        this.setColumnName(columnName);
        this.setMessage("El valor introducido en "+this.getColumnName()+" no es válido, tiene que ser mayor que cero.");
    }
    ...
    public boolean validate() throws ValidationException {
        ...
        SimplePositiveValidator snv=new SimplePositiveValidator(cadena);
        if(snv.validate()){
            return true;
        }
