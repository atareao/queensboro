 ...
 * @author Protactino
 */
public class QueryCount extends Query {
    //
    //********************************CONSTANTES********************************
    //
     ...
     * @param conditions 
     */
    public QueryCount(String schemaName,String tableName,Vector<Condition> conditions){
        this.setSchemaName(schemaName);
        this.setTableName(tableName);
        this.setConditions(conditions);
    }
    public QueryCount(String schemaName,String tableName){
